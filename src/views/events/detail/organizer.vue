    ...
    getDetail(events_id) {
      ...
      getEventsInfo(params).then(response => {
        ...
        if (response.resCode === 200) {
          response.resData.items[0].events_organizer_organizer = response
            .resData.items[0].events_organizer_organizer
            ? JSON.parse(response.resData.items[0].events_organizer_organizer)
            : [];
          response.resData.items[0].events_organizer_co_organizer = response
          ...
          response.resData.items[0].events_organizer_starategic_partner = response
            .resData.items[0].events_organizer_starategic_partner
            ? JSON.parse(
                response.resData.items[0].events_organizer_starategic_partner
              )
            : [];
          response.resData.items[0].events_organizer_media_support = response
            .resData.items[0].events_organizer_media_support
            ? JSON.parse(
